...
enum WorldIntConfigs
{
    ...
    CONFIG_HAVENLAB_CHAT_NOTIFY,
    CONFIG_MOTHER_CONTAMINANT_MODE,
    CONFIG_MOTHER_REQUIRE_CURIOUS_CORRUPTION,
    INT_CONFIG_VALUE_COUNT
};

enum HavenLabChatNotify : uint32
{
    HAVENLAB_CHAT_NOTIFY_OFF          = 0,
    HAVENLAB_CHAT_NOTIFY_STAFF_NORMAL = 1,
    HAVENLAB_CHAT_NOTIFY_STAFF_GM_ON  = 2
};
