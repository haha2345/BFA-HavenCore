...
void AddSC_corruption_spell_scripts()
{
    ...
    static uint32 const nyalothaWeaponDump[] = {
        SPELL_DEVOUR_VITALITY_ITEM, SPELL_DEVOUR_VITALITY_PROC, SPELL_DEVOUR_VITALITY_LEECH,
        SPELL_SEARING_FLAMES_ITEM, SPELL_SEARING_FLAMES_PROC, SPELL_SEARING_FLAMES_BUFF, SPELL_SEARING_FLAMES_BREATH,
        SPELL_WHISPERED_TRUTHS_PROC, SPELL_WHISPERED_TRUTHS_LOG,
        SPELL_LASH_OF_THE_VOID, SPELL_LASH_OF_THE_VOID_DAMAGE, SPELL_LASH_OF_THE_VOID_SLOW,
        SPELL_FLASH_OF_INSIGHT_ITEM, SPELL_FLASH_OF_INSIGHT_PROC, SPELL_FLASH_OF_INSIGHT_BUFF,
        SPELL_OBSIDIAN_SKIN, SPELL_OBSIDIAN_DESTRUCTION, SPELL_OBSIDIAN_DESTRUCTION_DAMAGE
    };
