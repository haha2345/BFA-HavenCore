...
| A3 | 回响虚空 | 有 GCD 的伤害技能叠层，有几率坍缩，按生命百分比对周围持续暗影。做法：[做法-A3-虚空回响.md](做法-A3-虚空回响.md) |
| A4 | 扭曲的附肢 | 第 1 层通过。有几率在身边召唤触须打当前目标。做法：[做法-A4-扭曲的附肢.md](做法-A4-扭曲的附肢.md) |
| A5 | 虚空仪式 | 技能有几率每秒加全次级，20 秒最多 20 层。做法：[做法-A5-虚空仪式.md](做法-A5-虚空仪式.md) |
